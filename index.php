...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">PlantSnap &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Snap Fam<span>Pune</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">7756892436</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">pardeshivishakha01@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About PlantSnap</b></span>
				PlantSnap is e-commerce trading platform for plant owners....
			</p>
