		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="IndoorPlants" style="color: black;">Indoor Plants</option>
										<option value="Outdoor Plants" style="color: black;">Otdoor Plants</option>
				...
				<?php
					...
					if(isset($_GET['type']) AND $_GET['type'] == "indoorplants")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'indoorplants'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "outdoorplants")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'outdoorplants'";
					}
